...
namespace Implanner
{
    /// File I/O helpers for plan Export/Import. Folder lives under RimWorld's
    /// save data directory so it survives game reinstalls and is easy to find.
    /// (Adapted from EPrimeReadouts ReadoutsFiles; keep in lockstep.)
    public static class PlansFiles
    {
        private const string FolderName = "Implanner";
