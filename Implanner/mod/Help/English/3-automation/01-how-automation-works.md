...
Batching keeps colonists off the operating table until several implants
can be installed in one anesthetic sleep. A batch is everything the
colonist needs next, either their current tier or their whole plan,
depending on the iteration strategy (see
[surgery options](topic:surgery-options)).
